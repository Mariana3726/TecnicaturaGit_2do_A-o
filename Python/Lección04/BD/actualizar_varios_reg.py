...
# se usa para manejar errores de forma segura y cerrar la conexión pase lo que pase
    with conexion:
        with conexion.cursor() as cursor:
            ...
            valores = (
                ('Juan Carlos', 'Roldán', 'jcarlosr@gmail.com', 4),
                ('Romina', 'Ayala', 'romayala@hotmail.com', 6)

            ) #es una tupla de tuplas
            cursor.executemany(sentencia, valores) #de esta manera ejecutamos la sentencia,executemany para varios registros
